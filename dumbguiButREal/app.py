...
from videolanedetect import process_video, main  # Import frame processing from LineProcessing.py
import cv2
...
ARROW_IMAGE_PATH = "arrowimage.png"
...
def overlay_video_feed():
    def generate_frames():
            ...
            while video_Stream:
                ...
                processed_frame = process_video(VIDEO_PATH, ARROW_IMAGE_PATH, frame, frame_width, frame_height, fps)
