...
def compass_overlay(image, angle):
    ...
    window_height, window_width = background.shape[:2]
    roi = background[:new_height, window_width-new_width:window_width]
    ...
    blended_roi = (
        ...
        np.uint8)
    background[:new_height, window_width-new_width:window_width] = blended_roi
